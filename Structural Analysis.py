...
while(choice == 'y'):
    ...
    # Instructions menu
    print("\nInstructions menu:-")
    print("1:-> Create a structural problem.")
    ...
    if instruction == '1':
        ...
        # Menu for method of analysis
        print("\nThe two main types of method of analysis are:- ")
        print("1:-> Force Method")
        print("2:-> Displacement Method")

        # User is asked whether he or she wishes to analyse the structure using force method or displacement method
        structural_method_of_analysis = input("\nPlease select the type of method of analysis (1 or 2) : ")

        # If the user selects Force method of analysis then the following if statement will be executed
        if structural_method_of_analysis == '1':
            print("You have selected Force method of analysis.")
