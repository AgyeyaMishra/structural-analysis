...
while(choice == 'y'):
    ...
    if type_of_beam =='1':
        ...
        if load01== '1':
            p = input('Load Magnitude in N : ')
            l = input("Length of beam in mm : ")
            E = input("Modulus of Elasticity of the material of beam in N/mm^2 : ")
            I = input("Moment of Inertia of beam in mm^4 : ")
            print()
